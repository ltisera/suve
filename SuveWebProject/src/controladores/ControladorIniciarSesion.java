...
public class ControladorIniciarSesion extends HttpServlet 
{
	...
	private void procesarPeticion(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try {
			...
			System.out.println("\n"+password+" = "+usuario.getPassword()+" ?: "+usuario.getPassword().equalsIgnoreCase(password));
			...
			salida.println("<Ahref=\"/SuveWebProject/usuario.html\">Volver...</A>");
			salida.println(" </BODY>");
			salida.println("</HTML>");
		}
		catch (Exception e) 
		{
			response.sendError(500, "Error (controlador iniciar sesion).");
		}
	}
}
